...
class CalendarioCorrectivoController extends Controller
{
          // =================== CALENDARIO =====================
          ...
          public function index(){
            ...
            return view("admin.correctivo.cronograma",[
              'data' => $data,
              'mes' => $mes,
              'mespanish' => $mespanish
            ]);
           ...
           while ($iweek < $semana):
               ...
               for ($iday=0; $iday < 7 ; $iday++){
                 ...
                 $datanew['evento'] = cronogramaFecha::
                   ...
                   ->join('departamentos', 'departamentos.id', '=', 'cronograma_preventivos.departamento_id')
                   ->select('fechas_preventivos.fecha','cronograma_preventivos.departamento_id','departamentos.nombre')
                   ->where("fecha",$datafecha)           
                   ->get();
                   */
    ...
    public function actualizar_fecha($id)
    {
