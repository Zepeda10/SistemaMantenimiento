...
<div class="contenido">
    <h2 class="text-center">Solicitudes atendidas de correo</h2>
	...
	<div class="col-md-7">
		<form id="form" action="{{route('admin.atencorreo')}}" method="get" class="mt-2 mb-5">
			<div class="row mb-4">
				<div class="col">
        ...
        <tbody>
			@foreach($datos as $dato)
				<tr>
                    ...
                    <td>
						<a href="{{route('telecomunicaciones.edit', $dato->id)}}" target="_blank">
