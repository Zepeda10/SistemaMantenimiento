...
<div class="contenido">
    <h2 class="text-center">Verificaciones Firmadas</h2>
    ...
    <table class="table">
        ...
        <tbody>
			@foreach($verificaciones as $verif)
				<tr>
					<td>
						<p>{{$verif->verificacion->departamento->nombre}}</p>
					</td>

					<td>
						<p>{{$verif->verificacion->created_at}}</p>
					</td>

                    <td>
						<a href="{{asset('pdfs/'.$verif->nombre)}}" target="_blank">
