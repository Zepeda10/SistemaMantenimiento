...
<div class="contenido">
	...
	<form id="form" action="{{route('orden-correctivo.index',$buscar,$departamentos)}}" method="get" class="mt-2 mb-5">
        <div class="row mb-4">
            <div class="col">
        ...
        <tbody>
			@foreach($ordenes as $orden)
				<tr>
                    ...
                    <td>
						<p>{{$orden->correctivo_id}}</p>
					</td>

					<td>
						<p>{{$orden->correctivo->departamento->nombre}}</p>
					</td>

                    <td>
						<p>{{$orden->correctivo->equipo->nombre}}</p>
					</td>
                    ...
                    <td>
						<a href="{{route('orden-correctivo.edit', $orden->id)}}" target="_blank">
